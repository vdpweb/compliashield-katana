...
$releaseNotes = "Alpha private release of Katana Ownin extender for CompliaShield OAuth"
...
$sourceToUploadTo = "https://nuget.compliashield.com/nuget"
...
#NuGet
#$apiKey = "d71509e9-3499-4f67-b9be-d46319949731"
